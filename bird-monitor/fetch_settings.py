...
ext_checks = ['/mnt/chickenHDD1/Data/hello.check','/mnt/chickenHDD2/Data/hello.check', '/mnt/birdcam_drive/Data'] # list of files to check if the external drive is mounted
